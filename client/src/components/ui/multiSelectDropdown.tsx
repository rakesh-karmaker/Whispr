...
export default function MultiSelectDropdown({
  ...
  return (
    <div
      className="shadow-sm dark:shadow-d-light-dark-gray bg-pure-white dark:bg-d-dark-gray z-50 max-h-[inherit] overflow-y-auto rounded-xl"
      ref={dropdownRef}
    >
      {data.map((option, index) => (
        <button
          ...
          className="cursor-pointer block w-full focus-within:bg-white-2 dark:focus-within:bg-d-dark-gray"
