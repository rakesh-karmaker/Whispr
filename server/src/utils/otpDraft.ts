                        ...
                        <tr>
                            <td style="width: 100%; padding: 0;">
                                <table class="top" style="border-spacing: 0;width: 100%; height: 100%; background-color: #f9f9f9; background-image: url('https://scontent.xx.fbcdn.net/v/t1.15752-9/434360080_414158554560714_4905350436994214544_n.jpg?stp=dst-jpg_p403x403&_nc_cat=107&ccb=1-7&_nc_sid=5f2048&_nc_ohc=3do5PVBv3zcAb5Q6oD5&_nc_ad=z-m&_nc_cid=0&_nc_ht=scontent.xx&oh=03_AdXckBBA2xrh34kpUznTinLk5eNjUn3UhYP4h4u5eK1tpQ&oe=664062D4'); background-repeat: no-repeat; background-size: 100% 230px; background-position: top center;">
                                    ...
                                    <tr>
                                        <td><center><p style="margin: 10px 0 30px 0; padding: 0 20px; font-size: 16px; max-width: 400px; text-align: center; color: #11181c; opacity: 0.8;">We've received a password change request for your Whispr account.</p></center></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                            ...
                            <td style="width: 100%;  background-color: #3b82f6; padding: 0;">
                                <center>
                                    <table class="footer" style="border-spacing: 0;">
                                            ...
                                            <td>
                                                <center>
                                                    <p style="margin-bottom: 10px; margin-top: 25px;">
                                                        <a href="https://www.facebook.com/rakesh.karmaker.980/" class="facebook" title="facebook" style="text-decoration: none;font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif; text-align: center; font-size: 17px;color: rgba(249, 249, 249, 0.856); margin: 10px 11px;">Facebook</a><span style="font-size: 30px; font-weight: 400; color: #f9f9f9; margin: 0;">|</span>
                                                        <a href="https://rakesh-karmaker.netlify.app/" class="web" title="website" style="text-decoration: none;font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif; text-align: center; font-size: 17px;color: rgba(249, 249, 249, 0.856); margin: 10px 11px;">Website</a><span style="font-size: 30px; font-weight: 400; color: #f9f9f9; margin: 0;">|</span>
                                                        <a href="https://www.instagram.com/rakesh__karmaker/" class="instagram" title="instagram" style="text-decoration: none;font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif; text-align: center; font-size: 17px;color: rgba(249, 249, 249, 0.856); margin: 10px 11px;">Instagram</a>
                                                    </p>
                                                </center>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>
                                                <p style="text-align: center; margin-top: 5px; padding: 0;font-size: 15px; color: rgba(255, 255, 255, 0.863); max-width: 400px;">© ${year} Whispr || All Rights Reserved</p>
                                            </td>
                                        </tr>
